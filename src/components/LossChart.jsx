...
function LossChart({ history, trainLabel = 'train loss', validationLabel = 'test loss' }) {
  ...
  return (
    <div className="chart-wrap">
      ...
      <div className="legend-row">
        <span><i className="legend-dot legend-dot-train" /> {trainLabel}: {formatMetric(lastPoint.loss)}</span>
        <span><i className="legend-dot legend-dot-test" /> {validationLabel}: {formatMetric(lastPoint.valLoss)}</span>
      </div>
    </div>
  );
}
